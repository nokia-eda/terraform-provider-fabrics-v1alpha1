...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-fabrics/internal/datasource_fabric"
...
const read_ds_fabric = "/apps/fabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/fabrics/{name}"

var (
	_ datasource.DataSource              = (*fabricDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*fabricDataSource)(nil)
)
...
func (d *fabricDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_fabric, map[string]string{
...
func (r *fabricDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
