...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-fabrics/internal/resource_fabric"
	"github.com/nokia/eda/apps/terraform-provider-fabrics/internal/tfutils"
)

const (
	create_rs_fabric = "/apps/fabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/fabrics"
	read_rs_fabric   = "/apps/fabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/fabrics/{name}"
	update_rs_fabric = "/apps/fabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/fabrics/{name}"
	delete_rs_fabric = "/apps/fabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/fabrics/{name}"
)

var (
	_ resource.Resource                = (*fabricResource)(nil)
	_ resource.ResourceWithConfigure   = (*fabricResource)(nil)
	_ resource.ResourceWithImportState = (*fabricResource)(nil)
)
...
func (r *fabricResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_fabric, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_fabric, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *fabricResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_fabric, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *fabricResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_fabric, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
