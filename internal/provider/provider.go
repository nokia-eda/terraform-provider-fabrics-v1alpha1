...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-fabrics/internal/eda/utils"
...
var _ provider.Provider = (*fabricsProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &fabricsProvider{version: ver}
	}
}

type fabricsProvider struct {
	version string
}
...
func (p *fabricsProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *fabricsProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *fabricsProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "fabrics-v1alpha1"
	resp.Version = p.version
}

func (p *fabricsProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
